...
router.get('/:id', function (req, res, next) {
  ...
  var fetchRejectedSolution = `SELECT * FROM Solutions INNER JOIN IntuitionStatus ON stsId = solStatusId WHERE solByempid = ${req.params.id} AND solStatusId = (SELECT stsId FROM IntuitionStatus WHERE StatusName = "Solution Rejected");`
